...
DEFAULT_MAX_DB_ENTRY_AGE_IN_DAYS = int(Variable.get("max_db_entry_age_in_days", 7)) # Length to retain the log files if not already provided in the conf. If this is set to 7, the job will remove those files that are 7 days old or older.
